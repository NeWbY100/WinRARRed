...
public partial class FileCompareForm : Form
{
    ...
    private static object? LoadFileData(string filePath)
    {
        ...
        {
            return RARFileData.Load(filePath);
        }
    }
    ...
    {
        return FileComparer.Compare(_leftData, _rightData, _leftDetailedBlocks, _rightDetailedBlocks);
    }
        ...
        if (node.Tag is CompareNodeData data)
        {
            if (data.NodeType == CompareNodeType.DetailedBlock && data.Data is RARDetailedBlock block)
            {
                ...
                if (otherBlocks != null)
                {
                    ...
                    if (otherBlock != null)
                    {
                        bool hasDiff = FileComparer.HasFieldDifferences(block, otherBlock);
    ...
    private void ShowSRRArchiveProperties(ListView listView, SRRFile srr, bool isLeft)
    {
        ...
        AddPropertyItem(listView, "RAR Version", FileComparer.FormatRARVersion(srr.RARVersion), isLeft, "RAR Version");
        AddPropertyItem(listView, "Compression Method", FileComparer.GetCompressionMethodName(srr.CompressionMethod), isLeft, "Compression Method");
        AddPropertyItem(listView, "Dictionary Size", FileComparer.FormatDictionarySize(srr.DictionarySize), isLeft, "Dictionary Size");
        AddPropertyItem(listView, "Solid Archive", FileComparer.FormatBool(srr.IsSolidArchive), isLeft, "Solid Archive");
        AddPropertyItem(listView, "Volume Archive", FileComparer.FormatBool(srr.IsVolumeArchive), isLeft, "Volume Archive");
        AddPropertyItem(listView, "Recovery Record", FileComparer.FormatBool(srr.HasRecoveryRecord), isLeft, "Recovery Record");
        AddPropertyItem(listView, "Encrypted Headers", FileComparer.FormatBool(srr.HasEncryptedHeaders), isLeft, "Encrypted Headers");
        ...
        AddPropertyItem(listView, "Has Comment", FileComparer.FormatBool(!string.IsNullOrEmpty(srr.ArchiveComment)), isLeft, "Has Comment");
    ...
    private void ShowRARArchiveProperties(ListView listView, RARFileData rar, bool isLeft)
    {
        ...
        {
            AddPropertyItem(listView, "Volume", FileComparer.FormatBool(rar.RAR5ArchiveInfo.IsVolume), isLeft, "Volume");
            AddPropertyItem(listView, "Solid", FileComparer.FormatBool(rar.RAR5ArchiveInfo.IsSolid), isLeft, "Solid");
            AddPropertyItem(listView, "Recovery Record", FileComparer.FormatBool(rar.RAR5ArchiveInfo.HasRecoveryRecord), isLeft, "Recovery Record");
            AddPropertyItem(listView, "Locked", FileComparer.FormatBool(rar.RAR5ArchiveInfo.IsLocked), isLeft, "Locked");
        ...
        {
            AddPropertyItem(listView, "Volume", FileComparer.FormatBool(rar.ArchiveHeader.IsVolume), isLeft, "Volume");
            AddPropertyItem(listView, "Solid", FileComparer.FormatBool(rar.ArchiveHeader.IsSolid), isLeft, "Solid");
            AddPropertyItem(listView, "Recovery Record", FileComparer.FormatBool(rar.ArchiveHeader.HasRecoveryRecord), isLeft, "Recovery Record");
            AddPropertyItem(listView, "Locked", FileComparer.FormatBool(rar.ArchiveHeader.IsLocked), isLeft, "Locked");
            AddPropertyItem(listView, "Encrypted Headers", FileComparer.FormatBool(rar.ArchiveHeader.HasEncryptedHeaders), isLeft, "Encrypted Headers");
            AddPropertyItem(listView, "File Count", rar.FileHeaders.Count.ToString(), isLeft, "File Count");
        }

        AddPropertyItem(listView, "Has Comment", FileComparer.FormatBool(!string.IsNullOrEmpty(rar.Comment)), isLeft, "Has Comment");
    }
    ...
    private void ShowRAR4FileProperties(ListView listView, RARFileHeader header, bool isLeft)
    {
        ...
        AddPropertyItem(listView, "Compression Method", FileComparer.GetCompressionMethodName(header.CompressionMethod), isLeft, "Compression Method");
        ...
        AddPropertyItem(listView, "Split Before", FileComparer.FormatBool(header.IsSplitBefore), isLeft, null);
        AddPropertyItem(listView, "Split After", FileComparer.FormatBool(header.IsSplitAfter), isLeft, null);
    }
    ...
    private void ShowRAR5FileProperties(ListView listView, RAR5FileInfo info, bool isLeft)
    {
        ...
        AddPropertyItem(listView, "Compression Method", FileComparer.GetCompressionMethodName(info.CompressionMethod), isLeft, "Compression Method");
        ...
        AddPropertyItem(listView, "Split Before", FileComparer.FormatBool(info.IsSplitBefore), isLeft, null);
        AddPropertyItem(listView, "Split After", FileComparer.FormatBool(info.IsSplitAfter), isLeft, null);
    }
