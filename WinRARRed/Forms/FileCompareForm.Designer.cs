...
partial class FileCompareForm
{
    ...
    private void InitializeComponent()
    {
        ...
        topPanel = new Panel();
        tlpFilePaths = new TableLayoutPanel();
        ...
        // topPanel
        //
        topPanel.Controls.Add(tlpFilePaths);
        ...
        // tlpFilePaths
        //
        tlpFilePaths.ColumnCount = 6;
        tlpFilePaths.ColumnStyles.Add(new ColumnStyle(SizeType.AutoSize));
        tlpFilePaths.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
        tlpFilePaths.ColumnStyles.Add(new ColumnStyle(SizeType.AutoSize));
        tlpFilePaths.ColumnStyles.Add(new ColumnStyle(SizeType.AutoSize));
        tlpFilePaths.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
        tlpFilePaths.ColumnStyles.Add(new ColumnStyle(SizeType.AutoSize));
        tlpFilePaths.Controls.Add(lblLeftFile, 0, 0);
        tlpFilePaths.Controls.Add(txtLeftFile, 1, 0);
        tlpFilePaths.Controls.Add(btnBrowseLeft, 2, 0);
        tlpFilePaths.Controls.Add(lblRightFile, 3, 0);
        tlpFilePaths.Controls.Add(txtRightFile, 4, 0);
        tlpFilePaths.Controls.Add(btnBrowseRight, 5, 0);
        tlpFilePaths.Dock = DockStyle.Fill;
        tlpFilePaths.Location = new Point(0, 0);
        tlpFilePaths.Name = "tlpFilePaths";
        tlpFilePaths.Padding = new Padding(3);
        tlpFilePaths.RowCount = 1;
        tlpFilePaths.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
        tlpFilePaths.Size = new Size(1400, 36);
        tlpFilePaths.TabIndex = 0;
        //
        // lblLeftFile
        //
        ...
        // txtLeftFile
        //
        txtLeftFile.Anchor = AnchorStyles.Left | AnchorStyles.Right;
        ...
        // btnBrowseLeft
        //
        btnBrowseLeft.Anchor = AnchorStyles.Left;
        ...
        lblRightFile.Margin = new Padding(12, 0, 3, 0);
        ...
        // txtRightFile
        //
        txtRightFile.Anchor = AnchorStyles.Left | AnchorStyles.Right;
        ...
        // btnBrowseRight
        //
        btnBrowseRight.Anchor = AnchorStyles.Left;
        ...
        tlpFilePaths.ResumeLayout(false);
        tlpFilePaths.PerformLayout();
    ...
    private TableLayoutPanel tlpFilePaths;
